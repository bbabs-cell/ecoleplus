      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-[1fr_1fr_auto] sm:items-end">
        <Champ label="Document" htmlFor="fichier" aide="PDF ou image, 25 Mo maximum.">
          <input
            ...
            className="w-full rounded-douce border border-bordure bg-carte px-3 py-2 text-sm text-encre file:mr-3 file:rounded file:border-0 file:bg-surface-2 file:px-3 file:py-1 file:text-sm file:text-encre"
          />
        </Champ>
